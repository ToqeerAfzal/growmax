...
const WallectConnectRestriction = ({address}) => {
 const reloadNow = () => {
          ...
          <Card className="feature-card">
            <CardContent className="p-6">
              ...
              <p className="mb-1" style={{ fontSize: 13}}>
                Oops! This wallet address is not accepted. Kindly connect using the correct address: 
              </p>
              <p className="mb-12" style={{ fontSize: 13, wordBreak: "break-all" }}>
                {address}.
              </p>
              <Button
                onClick={reloadNow}
...
export default WallectConnectRestriction;
